#!/usr/bin/env python3
# zodiac_main.py - 一生肖6窗口（8,10,12,18,20,30），二/三生肖5窗口（8,12,15,25,30）
...
# 一生肖专用窗口（6个）
SINGLE_WINDOWS = [8, 10, 12, 18, 20, 30]
# 二生肖和三生肖窗口（5个）
MAIN_WINDOWS = [8, 12, 15, 25, 30]
...
def backtest_all_zodiac(rows, lookback):
...
def main():
    ...
    if args.show:
        ...
        stats10 = backtest_all_zodiac(rows, 10)
        if stats10:
        ...
        stats100 = backtest_all_zodiac(rows, 100)
        if stats100:
